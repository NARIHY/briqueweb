...
<div class="container">
    <div class="row">
        <div class="col-md-6 bw-image-slider" >
              <div class="bw-square" style="color: rgba(57,119,128,0.75);">
                <h2 id="bw-titre">Brique <span style="color: rgba(57,119,128,0.75);">web</span> </h2>
              </div>
              <img src="images/female.webp" alt="" >
        </div>
        <div class="col-md-6 bw-image-slider" >
              <ol class="d-flex bw-reseau">
                <li class="nav-item ">
                  <a class="nav-link" href="#"><i class="fa-brands fa-instagram fa-2x"></i>&nbsp; Instagram</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="#"><i class="fa-brands fa-facebook fa-2x"></i> &nbsp; Facebook</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link " href="#"><i class="fa-brands fa-pinterest fa-2x"></i>&nbsp; Pinterest</a>
                </li>
              </ol>
              <div class="contact-btn" >
          <!--button class="btn btn-outline-warning text-uppercase btn-lg bw-btn-slider">Contactez nous</button-->
                  <div style="width: 80px; height: 80px;opacity: 0.2; background-color: white;border-top: 5px solid white;border-right: 5px solid white;position: absolute;margin-left: 10em;border-radius: 20px;margin-top: 10em;">
                  </div>
                  <button class="btn-contact btn-outline-warning text-uppercase btn-lg bw-btn-slider">
                    ...
                    <a href="contact.html" style="font-size: 16px;color: white;">Contact us</a>
                  </button>
                  </div>
              </div>
        </div>
...
<section class="bw-nos=avantage bg-dark ">
  <div class="container">
    <div class="row" style="margin-left: 0;margin-right: 0;">
        <div class="offer container col-lg-6">
            <h2 id="Nous_sommes"><i class="fa-solid fa-book-open" style="color:rgb(189, 123, 0); margin-right: 10px;"></i>Nos Avantages</h2>
            <h4>Notre specificité est notre force</h4>
            <p>
            Brique Web est une agence spécialisée en ingénierie informatique offrant une large gamme de services de développement, tels que la création de sites web, d'applications mobiles et d'applications web. Nous proposons également des services de conception de logos et de graphiques. Que vous soyez une entreprise, une institution ou un particulier, nous sommes ouverts à tous les projets créatifs numériques. Notre équipe dynamique d'experts qualifiés vous accompagne en fournissant des solutions technologiques web et mobiles complètes, adaptées à vos besoins, et ce, à des prix compétitifs. Nous vous offrons un site web abordable tout en créant un contenu de référence naturel de qualité. Confiez-nous la gestion de vos projets numériques pour améliorer l'image de votre entreprise et augmenter votre visibilité.
            </p>
            <button class="cta">
    ...
    <div id="services" class="container containE services-area area-padding">
      ...
      <div class="divv">
          <div style="position: absolute;height: 200px; width: 200px; background-color: rgba(255, 166, 0, 0.082);border-radius: 20px;margin-left: -20px;"></div>
          <div style="position: absolute;height: 200px; width: 200px; background-color: rgb(53, 52, 52);border-radius: 500%;margin-left: -100px;left: 40%;margin-top: 300px;"></div>
          <div style="position: absolute;height: 100px; width: 100px; background-color: rgba(95, 158, 160, 0.219);border-radius: 20px;margin-left: -100px;margin-top: 120px;left: 70%;"></div>
          <div style="position: absolute;height: 100px; width: 100px; background-color: rgba(95, 158, 160, 0.219);border-radius: 20px;margin-left: -100px;margin-top: 520px;left: 50%;"></div>
      </div>
      <div class="row" style="margin-left: 0; margin-right: 0">
          <div class="card_ car_s col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="car_no card_ col-lg-4 col-md-6 col-sm-12">
                <div class="about-move">
                    <div class="services-details">
                        <div class="single-services"  data-toggle="modal" data-target="#exampleModal4">
                            <a class="services-icon" >
                            ...
                            <h4>Création de site vitrine / E-Commerce</h4>
                            <p>
            ...
            <div class="car_s card_ col-lg-4 col-md-6 col-sm-12">
                <div class=" about-move">
                    <div class="services-details">
                        <div class="single-services"  data-toggle="modal" data-target="#exampleModal5">
                          <a class="services-icon">
                              <!-- WEBAPP DEVELOPMENT -->
                                <div class="grid--cell">
                          ...
                          <h4>Refonte de votre site web</h4>
                          <p>
            ...
            <div class="car_no card_ col-lg-4 col-md-6 col-sm-12">
              <div class=" about-move">
                <div class="services-details">
                  <div class="single-services">
                    ...
                    <h4>Création de votre logo / Retouche et détourage </h4>
                    <p data-toggle="modal" data-target="#exampleModal6">
              ...
              <div class="car_s card_ col-lg-4 col-md-6 col-sm-12">
                ...
                <div class=" about-move">
                  <div class="services-details">
                    <div class="single-services"  data-toggle="modal" data-target="#exampleModal7">
                      <a class="services-icon">
                          <div class="grid--cell">
                      ...
                      <h4>Services de référencement</h4>
                      <p>
                      Nous proposons également des services de référencement qui améliorent le positionnement et la visibilité de votre site web sur les pages de résultats des moteurs de recherche et des annuaires. Cela permet d'augmenter le nombre de visites sur votre site, ainsi que sa popularité et sa visibilité en ligne, en communiquant avec de nouveaux groupes cibles d'internautes.
                      </p>
                    </div>
                  </div>
                  <!-- end about-details -->
              ...
              <div class="car_no card_ col-lg-4 col-md-6 col-sm-12">
                ...
                <div class=" about-move">
                  <div class="services-details">
                    <div class="single-services"  data-toggle="modal" data-target="#exampleModal8">
                      <a class="services-icon">
                      ...
                      <h4>Rédaction de vos contenue</h4>
                      <p>
...
@section('scripts')
    ...
    <script>
        function fermer(id) {
            const fermer = document.getElementById("id-popup");
            const newid = "id-popup-" + id;
            console.log(newid);
            const fermer_id = document.getElementById(newid);

            fermer.classList.toggle("fermer");
            fermer_id.classList.toggle("fermer");
        }
    </script>
@endsection
